...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CILINDRO, CONO, ESFERA, FIGURA_PLY, EXTRUSION, ZORRO, CUBOP, NUBE,OBJETO} _tipo_objeto;
...
_zorro zorro;
_cubop cubop(0.85,1.3);
_nube nube(0.6, 0.4, 20, 20);
_objeto objeto;
...
switch (t_objeto){
    ...
    case CUBOP: cubop.draw(modo,1.0,0.0,0.0,5);break;
    case NUBE: nube.draw(modo,1.0,0.0,0.0,5);break;
    case OBJETO: objeto.draw(modo,1.0,0.0,0.0,5);break;    
	}
...
switch (toupper(Tecla1)){
	...
	case 'S': 
        ...
        case 'Z':t_objeto=CUBOP;break;
        case 'V':t_objeto=NUBE;break;
        case 'Y':t_objeto=OBJETO;break;
	}
glutPostRedisplay();
}
...
switch (Tecla1){
	...
	case GLUT_KEY_F1:objeto.giro_base2-=5;break;
   	case GLUT_KEY_F2:objeto.giro_cl1-=5;break;
